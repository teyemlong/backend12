...
public class ContactsApplication {
	...
	public static void main(String[] args) throws ParseException {
		...
		contactsRepository.save(new Contacts("Nguimfack", "Martial", df.parse("2018-11-12"), "sobajoo@gmail.com", 4521540, "tof.png"));
		contactsRepository.save(new Contacts("B", "A", df.parse("1983-11-12"), "tey@gmail.com", 58135729, "tof.png"));
